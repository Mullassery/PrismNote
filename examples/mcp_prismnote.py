"""Example: PrismNote MCP 2.0 Integration"""

import asyncio
from prismnote import PerceptionEngine  # Adjust import based on project
...
async def main():
    ...
    print(f"✓ PrismNote MCP 2.0 running at {mcp_url}")
