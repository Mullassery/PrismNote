...
**Modern data science notebook. Explore data faster than writing code. SQL + Python + AI, all in one local-first tool.**

<p>
  <strong>Stop context-switching between Jupyter, SQL IDE, data explorer, and spreadsheet tools.</strong><br>
  <em>Everything you need to understand data is here.</em>
</p>
